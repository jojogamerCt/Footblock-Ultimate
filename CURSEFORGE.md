...
**Footblock Ultimate** is the next-generation sequel to the original *Footblock* mod! Re-engineered from the ground up for Minecraft **1.21.1**, it brings premium physics-based gameplay, tactile controls, and a custom HUD right into your blocky world. Whether you want to play a quick casual match with friends or set up a competitive football stadium, Footblock Ultimate has you covered!
...
*   **Survival-Friendly Spawning**: Right-click the ground with the football item to spawn the ball entity. Right-click the entity to retrieve it as an item at any time.

---

## 🎮 Controls & How to Play

1.  **Spawn the Ball**: Get the **Football** item from your creative menu (or craft it) and **Right-Click** the ground.
2.  **Dribble**: Simply walk into the ball. It will attach to your feet and roll in front of you as you walk or sprint.
3.  **Drop/Release**: Want to pass the ball without kicking? **Crouch (Shift)** while dribbling to detach the ball and leave it in place.
